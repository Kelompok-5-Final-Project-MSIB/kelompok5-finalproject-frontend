...
const Page = () => {
  return (
    <>
      ...
      <section>
        <div className='px-4 md:px-10 mt-[50px] mb-4'> {/* Adjusted margin-bottom */}
          <div className='py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6'>
            <nav className="flex mb-4" aria-label="Breadcrumb">
              <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li className="inline-flex items-center">
                  <a href="#" className="inline-flex items-center text-lg font-medium text-gray-700 hover:text-blue-900">
            ...
            <div className='max-w-screen-full mt-4 border border-gray-200 mb-4 lg:mb-2 text-left'>
              <a href='#' className='flex items-center justify-start w-auto h-8 m-2 text-gray-900'>
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z"/>
      ...
      <div className='max-w-screen-full  border border-gray-200  '>
        </div>
        </div>
      </section>
      <section className="py-8 px-4 mx-auto max-w-screen-xl lg:px-6 antialiased"> {/* Adjusted margin-top */}
        <form action="#" className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div className='max-w-screen-full border border-gray-200 mb-4 lg:mb-8 text-left'>
            <h2 className='mt-2 font-semibold text-lg text-gray-600 lg:ml-6'>
              Produk Pemesanan
            </h2>
  ...
  <div className="flex items-start sm:items-center">
    ...
    <label htmlFor="terms-checkbox-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> I agree with the <a href="#" title="" className="text-primary-700 underline hover:no-underline dark:text-primary-500">Terms and Conditions</a> of use of the Flowbite marketplace </label>
  </div>
  <div className="gap-4 sm:flex sm:items-center">
    <button type="button" className="w-full rounded-lg border border-red-200 bg-red-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-red-500 hover:text-gray-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-red-100">Return to Shopping</button>
    <button type="submit" className="mt-4 flex w-full items-center justify-center rounded-lg bg-green-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 sm:mt-0">Send the order</button>
  </div>
</div>
