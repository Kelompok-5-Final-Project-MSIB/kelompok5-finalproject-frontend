              ...
              <table id="user-table" className="w-full text-sm text-left text-gray-500">
                <thead className="text-xs text-gray-50 uppercase bg-cream1">
                  <tr>
                    ...
                    <th scope="col" className="lg:px-4 lg:py-3 px-2 py-3">Role</th>
                ...
                <tbody>
                  ...
                  <tr className="border-b hover:bg-gray-100">
                    ...
                    <td className="px-4 py-3">Budi Pamungkas
                    </td>
                    <td className="px-4 py-3">Budi@gmail.com
                    </td>
                    <td className="px-4 py-3">Admin
                    </td>                   
